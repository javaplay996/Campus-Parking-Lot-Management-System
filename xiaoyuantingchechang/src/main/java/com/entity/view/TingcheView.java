 ...
 */
@TableName("tingche")
public class TingcheView extends TingcheEntity implements Serializable {
	...
	public TingcheView(TingcheEntity tingcheEntity) {
		try {
			BeanUtils.copyProperties(this, tingcheEntity);
