    ...
    */
    ...
    public R info(@PathVariable("id") Long id){
        ...
        if(chewei !=null){
            ...
            //级联表
            TingchequyuEntity tingchequyu = tingchequyuService.selectById(chewei.getTingchequyuId());
            if(tingchequyu != null){
    ...
    */
    ...
    public R save(@RequestBody CheweiEntity chewei, HttpServletRequest request){
        ...
        Wrapper<CheweiEntity> queryWrapper = new EntityWrapper<CheweiEntity>()
            .eq("chewei_bianhao", chewei.getCheweiBianhao())
            .eq("chewei_name", chewei.getCheweiName())
            .eq("tingchequyu_id", chewei.getTingchequyuId())
            ;
