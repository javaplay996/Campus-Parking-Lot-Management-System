...
public class YonghuController {
    ...
    */
    ...
    public R resetPassword(@RequestBody YonghuEntity yonghu){
        YonghuEntity yonghu1 = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("username", yonghu.getUsername()).orNew().eq("yonghu_name", yonghu.getYonghuName()));
        if(yonghu1==null){
            return R.error("教师不正确");
        }
        yonghu1.setPassword("123456");
